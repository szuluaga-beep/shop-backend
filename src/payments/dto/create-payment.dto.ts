...
import { IsCreditCard, IsEmail, IsInt, IsNotEmpty, IsNumber, IsPositive, IsString, Matches, MaxLength } from "class-validator";
...
export class CreatePaymentDto {
    ...
    @ApiProperty({
        description: "Credit card number must be a valid Visa or MasterCard number.",
